...
function getPipeline(onnxModelId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!extractor) {
            const { pipeline } = yield (0, tokenizer_1.getTransformers)();
...
function localEmbed(request) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = (0, model_registry_1.getModelConfig)(request.model);
        const dimension = (0, model_registry_1.validateDimension)(config, request.outputDimension);
        (0, model_registry_1.validatePrecision)(config, request.outputDtype);
        ...
        const tokenizer = yield (0, tokenizer_1.getTokenizerForModel)(request.model);
        let totalTokens = 0;
        for (const text of inputs) {
